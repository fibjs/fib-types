...
declare class DgramSocket_Classbase extends EventEmitter_Classbase {
	...
	/**
		...
		* @async
		*/
	send(msg: Buffer_Classbase, port: number, address?: string/** = ""*/): number;
	...
	/**
		...
		* @async
		*/
	send(msg: Buffer_Classbase, offset: number, length: number, port: number, address?: string/** = ""*/): number;
