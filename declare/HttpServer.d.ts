...
declare class HttpServer_Classbase extends TcpServer_Classbase {
	...
	/**
		...
		* 
		*/
	constructor(port: number, hdlr: Handler_Classbase);
	...
	/**
		...
		* 
		*/
	constructor(addr: string, port: number, hdlr: Handler_Classbase);
