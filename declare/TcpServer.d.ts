...
declare class TcpServer_Classbase extends _object_Classbase {
	...
	/**
		...
		* 
		*/
	constructor(port: number, listener: Handler_Classbase);
	...
	/**
		...
		* 
		*/
	constructor(addr: string, port: number, listener: Handler_Classbase);
